    ...
    <>
      <div className="container-wiki">
        ...
        >
          ...
          sint, corrupti deleniti tempore natus voluptatum molestiae optio ex
          laboriosam deserunt officia aliquam reiciendis fugiat voluptates est
          debitis laudantium, sunt quis hic odit suscipit ut tempora inventore.
          Culpa, quidem ex quod aut repudiandae ratione eligendi ad assumenda
          totam, dolorum quasi necessitatibus facere voluptatibus cupiditate,
          quos nemo voluptate. Iste, ab dolorum adipisci veritatis earum aliquam
          ex nemo minima quo vitae impedit nesciunt repellat quam asperiores
          dolor, eveniet vero non placeat cupiditate doloribus temporibus
          dolorem ipsam sapiente rerum. Omnis, est voluptate error quia culpa
          debitis? Excepturi eum exercitationem praesentium facilis, ducimus a.
          Nisi modi alias quas, voluptas corporis, nobis animi commodi odit
          velit eius iste natus repellendus minus necessitatibus laudantium ab
          nihil.
        </p>
        ...
        <Table striped bordered hover>
          <thead>
            <tr>
              <th style={{ backgroundColor: "#db4444", color:"#fff", width: "60px" }}>
                Picture
              </th>
              <th style={{ backgroundColor: "#db4444", color:"#fff", width: "30px" }}>
                Name
              </th>
              <th style={{ backgroundColor: "#db4444", color:"#fff", width: "30px" }}>
                English Name
              </th>
              <th style={{ backgroundColor: "#db4444", color:"#fff", width: "200px" }}>
                Role
              </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >
            ...
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Private eye and Ran's father. Separated from Eri Kisaki, Ran's mother.`}</td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Member of the Detective Boys. She likes Conan and she considers Haibara her best friend.`}</td>
            </tr>
            <tr>
              <td style={{ width: "60px" }}>
                <Image
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Member of the Detective Boys. The most intelligent true child in the Detective Boys. He is great when it comes to science and logic.`}</td>
            </tr>
            <tr>
              <td style={{ width: "60px" }}>
                <Image
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Member and self-proclaimed leader of the Detective Boys. Loves to eat, especially roasted eel on rice.`}</td>
            </tr>
            <tr>
              <td style={{ width: "60px" }}>
                <Image
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Ran's best friend. The youngest daughter of the wealthy Suzuki family.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Ran's mother, a very successful attorney. Married to, but currently living separately from Kogoro Mouri. She is a friend of Yukiko Kudo.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              >
                {" "}
                {`Shinichi's father. A famous mystery novel author who is well-known in both America and Japan.`}
              </td>
            </tr>
          </tbody>
          <tbody>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Heiji Hattori's best friend since childhood and love interest. She is a trained Aikido martial artist.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Star who is idolized by Kogoro Mouri.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Conan's homeroom teacher and Ninzaburo Shiratori's girlfriend. Also the self-proclaimed manager of the Detective Boys.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Kogoro's doctor, Teitan school nurse, and a high school basketball coach. He was once impersonated by Vermouth.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Sonoko Suzuki's boyfriend, and a karate champion that has been admired by Ran.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Sonoko's uncle, who is obsessed with embarrassing and outsmarting Kaitou Kid.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A kind worker at the coffee shop that is right under the Mouri Detective Agency, who sometimes has a case that she wants Kogoro to solve.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A high school detective who transfers into Ran and Sonoko's high school class. She is the younger sister of Shuichi Akai and Shukichi Haneda.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Yumi Miyamoto's boyfriend and a professional shogi player. Also the brother of Shuichi Akai and Masumi Sera.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A housekeeper and Naeko Miike and Kazunobu Chiba's childhood friend.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A Kyoto high school student who claims that Heiji is her future husband.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`The new deputy homeroom teacher of class 1-B of Teitan Primary school. She is also somehow connected to Kohji Haneda and the case from 17 years ago.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`The butler of Momiji's family, and a former member of the PSB.`}</td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Female police officer who works with Inspector Megure. Currently involved with Detective Takagi.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Police officer who works with Inspector Megure. Currently involved with Detective Sato.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Police officer who often works with Inspector Megure. He is Naeko Miike's childhood friend and love interest.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A traffic enforcer and Detective Sato's best friend who is a compulsive tease. Also Shukichi Haneda's girlfriend.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A traffic enforcer working with Yumi Miyamoto. She is Kazunobu Chiba's childhood friend and love interest.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Senior Superintendent of the Tokyo Metropolitan Police 1st Division and Inspector Megure's superior.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`The head inspector of the arson squad and Kogoro Mouri's former superior.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Superintendent of the Tokyo Metropolitan Police 2nd Division and Ginzo Nakamori's superior.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`A member of the Tokyo MPD bomb squadron who died on duty three years ago. He is Sato's first love.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              >
                {" "}
                {`A member of the Tokyo MPD bomb squadron who died on duty seven years ago. He was Matsuda's best friend.`}
              </td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              >
                {" "}
                {`A deceased police officer who was Takagi's mentor and Amuro's friend.`}
              </td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Heiji Hattori's father, and a police chief from Osaka Police District.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              >
                {" "}
                {`Inspector from Osaka Police District, and a very close friend to Heiji and Heizo.`}
              </td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Inspector from Nagano Police District, partially disabled after surviving an avalanche.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Kansuke Yamato's former partner who has recently returned to the force.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Inspector from Nagano Police District. Childhood friend and rival of Kansuke Yamato. He is also the older brother of Hiromitsu Morofushi.`}</td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Detective from Gunma Police District, albeit a not very good one. Is later promoted to "Inspector".`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Sango Yokomizo's twin brother, also an inspector from Kanagawa Police District. He is not as easygoing as his brother.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`An investigator from the Tokyo Metropolitan Police Department's Public Security Bureau and Rei's Subordinate.`}</td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`An FBI agent on an undercover assignment against the Black Organization, and Ran's English teacher at one point.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`High ranking FBI agent, Jodie's superior.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{` FBI agent, played a vital role in the protection of Rena Mizunashi.`}</td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              >
                {" "}
                {`Deceased CIA member who infiltrated the Black Organization. He is also Hidemi and Eisuke's father.`}
              </td>
            </tr>
          </tbody>
        </Table>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Member of the Black Organization. Gin's secretary and partner on most occasions.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Akemi and Shiho Miyano's mother. Deceased member of the Black Organization known as Hell's Angel.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Akemi Miyano and Shiho Miyano's father. Deceased member of the Black Organization known as the "Mad Scientist".`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Member of the Black Organization, originally trying to get programs and a list of the world's top programmers. Was accidentally killed by a bomb.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "30px", lineHeight: "15px" }}
              >{`Ki'ichiro Numabuchi`}</td>
              <td style={{ width: "30px", lineHeight: "15px" }}>
                Cornelius Graver
              </td>
              <td
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Shukichi's non-blood brother and a professional shogi player. He was forced to take APTX 4869, and died as a result 17 years ago.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`High school student and magician. Aoko Nakamori's childhood friend, and love interest. Son of world-renowned magician Toichi Kuroba.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Secret identity of Kaito Kuroba. Magician and thief, also known to be "uncatchable".`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Kaito Kuroba's childhood friend, and love interest. Daughter of Ginzo Nakamori.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Inspector from Tokyo Metropolitan Police 2nd Division, who is obsessed with capturing Kaitou Kid.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Kaito Kuroba's mother. Before meeting her husband, she was a jewel thief known as Phantom Lady.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
              ...
              <td
                style={{ width: "200px", padding: "0 5px", textAlign: "left" }}
              >{`Once Toichi Kuroba's attendant and friend, now Kaito's assistant.`}</td>
            </tr>
          </tbody>
          <tbody>
            <tr>
